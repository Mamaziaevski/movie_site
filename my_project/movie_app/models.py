...
class Director(models.Model):
    director_name = models.CharField(max_length=64, unique=True)
...
class Movie(models.Model):
    ...
    status_movie = models.CharField(choices=STATUS_CHOICES, max_length=20)
    video = models.CharField(choices=STATUS_CHOICES)
